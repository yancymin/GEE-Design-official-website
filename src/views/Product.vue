<template>
    <div class="product" id="main">
        ...
        <div class="container">
            ...
            <div class="product-color bottom-80" :id="'anchor-' + jsonData[1].id">
                <h3>产品标志颜色</h3>
            ...
            <div class="typeface bottom-80" :id="'anchor-' + jsonData[2].id">
                <h3>产品标志字体</h3>
            ...
            <div class="size-arrangement bottom-80" :id="'anchor-' + jsonData[3].id">
                <h3>尺寸与排列</h3>
            ...
            <div class="logo-alignment bottom-80" :id="'anchor-' + jsonData[4].id">
                <h3>产品标志版式</h3>
            ...
            <div class="limited-use" :id="'anchor-' + jsonData[5].id">
                <h3>使用限制</h3>
